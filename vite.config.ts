  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'Repstack',
        description:
          'Open source hypertrophy training application for evidence-based muscle building',
        theme_color: '#1a202c',
      ...
      workbox: {
        ...
        // Maximum size to precache (10MB)
        maximumFileSizeToCacheInBytes: 10 * 1024 * 1024,
        runtimeCaching: [
          {
            // Cache images with a Cache First strategy (excluding .ico, which are precached)
          ...
          {
            // Cache external fonts if any are added in the future
          ...
          {
            // Prepare for future API calls - Network First with offline fallback
            urlPattern: /\/api\/.*/i,
